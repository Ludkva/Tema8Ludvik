...
var app = (function () {
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			button0.textContent = "Trykk her";
    			t5 = space();
    			button1 = element("button");
    			button1.textContent = "Status sjekk";
    			attr_dev(h1, "class", "svelte-2x1evt");
    			add_location(h1, file, 38, 1, 992);
    			attr_dev(div, "class", "stuff");
    			add_location(div, file, 37, 1, 946);
    			add_location(p, file, 40, 4, 1032);
    			add_location(button0, file, 41, 1, 1047);
    			add_location(button1, file, 42, 1, 1131);
    			attr_dev(main, "class", "svelte-2x1evt");
    			add_location(main, file, 36, 0, 938);
    		},
    ...
    function instance($$self, $$props, $$invalidate) {
    	...
    	const click_handler = () => showNotification("Dear Mr or Mrs, ");
